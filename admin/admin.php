...
<body>
    ...
    <a href="../index.php" class="btn btn-danger logout-btn">Cerrar sesión</a>
    </div>

    <div class="card-container">
    <div class="card" onclick="location.href='adminuser.php'">
    <img src="" alt="Consulta usuarios">
    <p>Consulta de usuarios</p>
    </div>

    <div class="card" onclick="location.href='notas.php'">
    <img src="" alt="consulta notas de los usuarios y agregar">
